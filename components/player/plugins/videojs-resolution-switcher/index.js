     ...
     */
            ...
            createItems: function () {
                ...
                for (var key in labels) {
                    if (labels.hasOwnProperty(key)) {
                        ...
                        menuItemsHolder[labels[key][0].res] = menuItems[menuItems.length - 1];
                    }
                }
                return menuItems;
            }
        ...
        videoJsResolutionSwitcher = function (options) {
            ...
            player.updateSrc = function (src) {
                ...
                videojs.addClass(label, 'vjs-resolution-button-label');
                videojs.addClass(label, 'iconfont');
                videojs.addClass(label, iconFontMap[choosen.res]);
                ...
                player.controlBar.resolutionSwitcher = player.controlBar.el_.insertBefore(menuButton.el_, player.controlBar.getChild('volumeControl').el_);
